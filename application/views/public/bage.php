                                    ...
                                    <div class="flex-row-fluid ml-lg-12">
                                        <div class="card card-custom">
                                            <div class="card-header">
                                                <div class="col-12 col-12 d-flex flex-center">
                                                    <span class="font-size-h1 d-block d-block font-weight-boldest text-dark-75 py-2">Bages</span>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="row mt-5">
                                                    <div class="col-6 col-6 d-flex flex-center">
                                                        <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                                            <div class="image-input-wrapper image-0" ></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 col-6 d-flex flex-center">
                                                        <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                                            <div class="image-input-wrapper image-1" ></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-5">
                                                    <div class="col-12 col-12 d-flex flex-center">
                                                        <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                                            <div class="image-input-wrapper image-2"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-5">
                                                    <div class="col-6 col-6 d-flex flex-center">
                                                        <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                                            <div class="image-input-wrapper image-3"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 col-6 d-flex flex-center">
                                                        <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                                            <div class="image-input-wrapper image-4"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
